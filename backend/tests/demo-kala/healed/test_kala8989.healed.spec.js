...
test('create product @sanity', async ({ page }) => {
  ...
  await heal(page, 'Customer Part Number textbox', 'fill', '333', () => page.getByRole('textbox', { name: 'Customer Part Number' }));
  ...
  await heal(page, 'Brand Name textbox', 'fill', 'ddd', () => page.getByRole('textbox', { name: 'Brand Name' }));
  ...
  await heal(page, 'Max OD (inches) spinbutton', 'fill', '33', () => page.getByRole('spinbutton', { name: 'Max OD (inches)' }));
  ...
  await heal(page, 'listitem nth(2)', 'visible', null, () => page.getByRole('listitem').nth(2));
  await heal(page, 'listitem nth(2)', 'click', null, () => page.getByRole('listitem').nth(2));
  ...
  await heal(page, 'Quantity in Sales UOM spinbutton', 'fill', '44', () => page.getByRole('spinbutton', { name: 'Quantity in Sales UOM' }));
  ...
  await heal(page, 'Description textbox', 'fill', 'rr', () => page.getByRole('textbox', { name: 'Description' }));
  ...
  await heal(page, 'Description textbox', 'visible', null, () => page.getByRole('textbox', { name: 'Description' }));
  await heal(page, 'Description textbox', 'click', null, () => page.getByRole('textbox', { name: 'Description' }));
  await heal(page, 'Description textbox', 'fill', 'rrrrrr', () => page.getByRole('textbox', { name: 'Description' }));
  ...
  await heal(page, 'Kishore Battula Fortis button', 'visible', null, () => page.getByRole('button', { name: 'Kishore Battula Fortis' }));
  await heal(page, 'Kishore Battula Fortis button', 'click', null, () => page.getByRole('button', { name: 'Kishore Battula Fortis' }));
