...
test('create customer @sanity', async ({ page }) => {
  ...
  await heal(page, 'customer name input', 'visible', null, () => page.locator('input[name="customer.name"][type="text"]'));
  await heal(page, 'customer name input', 'click', null, () => page.locator('input[name="customer.name"][type="text"]'));
  await heal(page, 'customer name input', 'fill', 'demo_auto1', () => page.locator('input[name="customer.name"][type="text"]'));
  ...
  await heal(page, 'customer name display', 'visible', null, () => page.locator('p').filter({ hasText: /^demo_auto1$/ }).first());
